...
class AgentServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.AskAgentStream = channel.unary_stream(
                '/AgentService/AskAgentStream',
...
def add_AgentServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'AskAgentStream': grpc.unary_stream_rpc_method_handler(
                    servicer.AskAgentStream,
